...
export const acatManifest = () => ({ manifest: [
  { src_id: 'MF1', system: 'sei', kind: 'URL',
    location: 'https://api-qa.seic.com/wealth/v2/openapi.json',
    domain: 'Accounts', enabled: 'Y', last_run_at: '07-28 06:00',
    last_result: 'OK · 42 endpoints' },
  { src_id: 'MF2', system: 'bloomberg', kind: 'FILE',
    location: 'D:/specs/bbg_ref.json', domain: 'MarketData',
    enabled: 'N', last_run_at: null, last_result: null }] });
