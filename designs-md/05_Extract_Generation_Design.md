...
**What breaks if this is wrong.** 1 component depends on it: #8 Landing Zone + Transport.

## 2. Context & Dependencies

- **Upstream** — depends on #8 Landing Zone + Transport
- **Downstream** — depended on by #8 Landing Zone + Transport
- Technology: Contract
