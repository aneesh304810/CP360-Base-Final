...
**What breaks if this is wrong.** 1 component depends on it: #65 Cost & Capacity Monitoring.

## 2. Context & Dependencies

- **Upstream** — depends on #52 Worker Pod Autoscaling
- **Downstream** — depended on by #65 Cost & Capacity Monitoring
- Technology: Infra
