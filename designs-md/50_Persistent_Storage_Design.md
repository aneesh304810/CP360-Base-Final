...
**What breaks if this is wrong.** 2 components depend on it: #29 Error Handling & Quarantine, #63 Backup & Restore.

## 2. Context & Dependencies

- **Upstream** — depends on #8 Landing Zone + Transport, #29 Error Handling & Quarantine
- **Downstream** — depended on by #29 Error Handling & Quarantine, #63 Backup & Restore
- Technology: Infra
