...
**What breaks if this is wrong.** 3 components depend on it: #15 Stage 2 Enriched (dbt), #21 Replay / Rerun Engine, #31 Audit & Lineage.

## 2. Context & Dependencies

- **Upstream** — depends on #15 Stage 2 Enriched (dbt), #16 Gold (dbt), #21 Replay / Rerun Engine
- **Downstream** — depended on by #15 Stage 2 Enriched (dbt), #21 Replay / Rerun Engine, #31 Audit & Lineage
- Technology: dbt
