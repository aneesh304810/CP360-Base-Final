...
**What breaks if this is wrong.** 1 component depends on it: #60 Database Change Management.

## 2. Context & Dependencies

- **Upstream** — depends on #16 Gold (dbt), #60 Database Change Management
- **Downstream** — depended on by #60 Database Change Management
- Technology: Oracle DDL + dbt
...
**Build note for this component.** PBDW is the system of record downstream. If any consumer needs an EOD-stable Gold, it is this one, and it should be the first contract written.
