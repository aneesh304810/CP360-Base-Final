...
**What breaks if this is wrong.** 1 component depends on it: #28 DQ Framework.

## 2. Context & Dependencies

- **Upstream** — depends on #14 Stage 1 RAW, #17 Correction Handling
- **Downstream** — depended on by #28 DQ Framework
- Technology: Python + dbt
