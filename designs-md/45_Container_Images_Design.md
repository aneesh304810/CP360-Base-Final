...
**What breaks if this is wrong.** 3 components depend on it: #46 Registry, Scanning, Signing, #54 Warm-start / Pre-pulled Images, #57 CI/CD Pipelines.

## 2. Context & Dependencies

- **Upstream** — depends on #57 CI/CD Pipelines
- **Downstream** — depended on by #46 Registry, Scanning, Signing, #54 Warm-start / Pre-pulled Images, #57 CI/CD Pipelines
- Technology: Infra
