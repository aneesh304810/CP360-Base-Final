...
**What breaks if this is wrong.** 1 component depends on it: #12 API Gateway / Data Plane.

## 2. Context & Dependencies

- **Upstream** — depends on #12 API Gateway / Data Plane
- **Downstream** — depended on by #12 API Gateway / Data Plane
- Technology: Contract
...
**Build note for this component.** Real-time consumers and intraday Gold are the same question from two directions. Answer the freshness contract once.
