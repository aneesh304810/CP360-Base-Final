...
**What breaks if this is wrong.** 6 components depend on it: #18 Airflow DAG + Per-Domain Fan-out, #53 Resource Quotas & Priority, #54 Warm-start / Pre-pulled Images, #55 Oracle Connection Pooling, #56 Node Placement, #65 Cost & Capacity Monitoring.

## 2. Context & Dependencies

- **Upstream** — depends on #18 Airflow DAG + Per-Domain Fan-out, #55 Oracle Connection Pooling
- **Downstream** — depended on by #18 Airflow DAG + Per-Domain Fan-out, #53 Resource Quotas & Priority, #54 Warm-start / Pre-pulled Images, #55 Oracle Connection Pooling, #56 Node Placement, #65 Cost & Capacity Monitoring
- Technology: Infra
...
**Build note for this component.** Scale on queued tasks. Also cap concurrency per micro-batch: the failure mode is not too few workers, it is every worker starting at once against one Oracle.
