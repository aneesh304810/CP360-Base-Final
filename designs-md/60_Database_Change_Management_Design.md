...
**What breaks if this is wrong.** 2 components depend on it: #16 Gold (dbt), #37 PBDW.

## 2. Context & Dependencies

- **Upstream** — depends on #16 Gold (dbt), #37 PBDW
- **Downstream** — depended on by #16 Gold (dbt), #37 PBDW
- Technology: Process + DDL
