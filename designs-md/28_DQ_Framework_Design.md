...
**What breaks if this is wrong.** 5 components depend on it: #23 G1 File / Structural Gate, #24 G2 RAW Profiling Gate, #25 G3 dbt Tests + Business Rules, #26 G4 Tie-out / Control Totals, #33 Metadata & Configuration Store.

## 2. Context & Dependencies

- **Upstream** — depends on #33 Metadata & Configuration Store, #31 Audit & Lineage
- **Downstream** — depended on by #23 G1 File / Structural Gate, #24 G2 RAW Profiling Gate, #25 G3 dbt Tests + Business Rules, #26 G4 Tie-out / Control Totals, #33 Metadata & Configuration Store
- Technology: Python
