...
**What breaks if this is wrong.** 1 component depends on it: #57 CI/CD Pipelines.

## 2. Context & Dependencies

- **Upstream** — depends on #45 Container Images, #57 CI/CD Pipelines
- **Downstream** — depended on by #57 CI/CD Pipelines
- Technology: Infra
